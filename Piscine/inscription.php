...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO client (profession, nom_client, prenom_client, email_client, mdp_client, photo_client, adresse, num_etudiant) VALUES (  '$profession','$nom', '$prenom', '$email', '$mdp', '$photo_client', '$adresse', '$num_etudiant')";
