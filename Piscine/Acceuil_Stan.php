...
if (isset($_SESSION['id_admin'])) {
    echo "<h3 style='color: black;'>Bonjour, " . htmlspecialchars($_SESSION['prenom_admin']) . " " . htmlspecialchars($_SESSION['nom_admin']) . "</h3>";

    // Vérifier si la clé 'photo_client' existe dans la session avant de l'utiliser
    if (isset($_SESSION['photo_admin']) && $_SESSION['photo_admin']) {
        echo "<img src='" . htmlspecialchars($_SESSION['photo_admin']) . "' alt='Photo de profil' style='width: 130px; height: 100px; border-radius: 100px; '>";
    } else {
        echo "<p>Photo de profil non disponible.</p>";
    }
}
...
?>
     ...
     <div class="footers">
       ...
       <a href="mailto:Sportify@gmail.com">ECE Paris Project &copy;</a>
