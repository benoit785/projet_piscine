document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const photo_client = canvas.toDataURL('image/png');
    // Ajoutez un input caché dans le formulaire avec la valeur de photo_client
    document.getElementById('photo_client').value = photo_client;
});
